...
- `/arena`（或旧入口 `/battle`）：魔法少女竞技场（生成战报；可选日常/羁绊/经典/情景模式；v0.8.1 起支持连续战报会话）
...
- 连续战报仍然是 **竞技场战报**：保留胜负、战报卡片、角色状态更新与章节链。
- 魔法茶会更像 **长期剧情聊天 / 跑团容器**：自由度更高，但不等价于竞技场战报。
- 如果你想写“同一场竞技之后的下一章、分支结局、赛后余波”，优先用连续战报；如果你想做自由互动长对话，再看 `/magic-tea-party`。
