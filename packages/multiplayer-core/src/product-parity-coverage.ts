...
/** Manual source inventory: a new generation semantic must be classified here and below. */
export const ARENA_GENERATION_REQUEST_SEMANTIC_KEYS = [
  'generationRequestId',
  'combatants',
  'mode',
...
export const ARENA_PRODUCT_PARITY_SEMANTIC_KEYS = Object.freeze({
  generationRequest: ARENA_GENERATION_REQUEST_SEMANTIC_KEYS,
  roomSharedConfig: [
    'battleMode',
    'combatants',
    ...
    'selectedLanguage',
    'historySettings',
    'historySettings.readArenaHistory',
    'historySettings.readArenaHistoryLimit',
    'historySettings.isArenaHistoryUnlimited',
    'historySettings.writeArenaHistory',
    'historySettings.readCurrentState',
    'historySettings.writeCurrentState',
    'historySettings.readNarrativeHistory',
    'historySettings.readNarrativeHistoryLimit',
    'historySettings.isNarrativeHistoryUnlimited',
    'historySettings.writeNarrativeHistory',
  ],
  proposalChanges: [
    'addCombatant',
    'removeCombatant',
