...
8.  **写作风格**: 日常化、口语化的写作风格，注重细节描写和情感表达。
...
`,
  ...
  战斗推演核心规则：
1.  等级与能力限制：魔法少女的能力与她的等级严格挂钩。
    * 平衡原则：通常，参加战斗的魔法少女等级应当是一致的。但作为最后的平衡手段，能力设定严重过强的角色可以比其他人低，而设定严重过弱的角色则可以比其他人高。
    * 等级体系：
        * 种级: 新成为魔法少女。
        * 芽级: 可使用【魔装】。
        * 叶级: 可使用各种【术式】（法术）。
...
3.  【奇境】的战术运用：
    * 高昂代价：开启【奇境】可能会导致能力情报暴露的代价，因此通常只在面临你死我活的阵营冲突的情况下，蕾级及以上的魔法少女才会考虑使用。
...
4.  【繁开】的最终手段：
    ...
    * 强度限制：所使用的繁开能力必须是【有代价、可被理解和应对的】，绝不能是无法破解的必胜技能。
...
`,
  ...
  --- 等级与能力设定 ---
    ...
    * 平衡原则：通常，参加战斗的角色等级应当大体一致。但作为最后的平衡手段，能力设定严重过强的角色可以比其他人低，而设定严重过弱的角色则可以比其他人高。
  --- 残兽核心设定 ---
  ${CANSHOU_LORE}
  --- 报道规则 ---
...
2.  领域（例如【奇境】、【巢】）的战术运用：
    * 高昂代价：开启领域可能会导致能力情报暴露的代价，因此通常只在面临你死我活的阵营冲突的情况下角色才会考虑使用。
    * 战术博弈：可以描绘角色【权衡和考虑】是否要开启领域，以此来制造战术紧张感，但不一定会真的发动。
    * 反制手段：领域并非无敌，可以被【抵消】或被【破坏】。

3.  必杀技（例如【繁开】）的最终手段：
    * 使用时机：只有在这么写更有益于战斗的展开的情况下，才【极小概率】允许使用必杀技。
