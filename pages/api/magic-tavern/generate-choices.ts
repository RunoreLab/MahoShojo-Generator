...
import { buildMagicTavernChoicesPrompt, buildWorldbookText } from '@/lib/magic-tavern/prompts';
...
const log = getLogger('api-magic-tavern-generate-choices');
...
export default async function handler(req: NextRequest): Promise<Response> {
  ...
  try {
    ...
    const prompt = buildMagicTavernChoicesPrompt({
      session: {
        playerRoleId,
        summary: undefined,
        settings: {
